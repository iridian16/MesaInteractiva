...
echo $row2[0];
 ...
 if($row2[0]==0){
    $cambia=ejecutarSQL::consultar("update usuarios set celular1=1 where id=$row1[0]");
 }else{
    $cambia=ejecutarSQL::consultar("update usuarios set celular2=1 where id=$row1[0]");
 }
?>
